/*! X-Precise - v2.3 - 2016-01-27 */ ! function(a) {
    ...
    a(document).mouseup(function() {
        ...
        drag: function(b, c, d) {
            ...
            }).left - d.margins.left)), !d.snapElements[m].snapping && (e || f || g || h || n) && d.options.snap.snap && d.options.snap.snap.call(d.element, b, a.extend(d._uiHash(), {
                snapItem: d.snapElements[m].item
    ...
    }), a.ui.draggable, a.widget("ui.slider", a.ui.mouse, {
        version: "1.11.0",
    ...
    function(a) {
        ...
        var b = {
            init: function() {
                b.interfaceAppend(), b.overlayChange(), b.overlayToggle(), b.overlayDrag(), b.overlayPosition(), b.overlayOpacity(), b.pageOpacity(), b.overlayFineTuning(), b.overUnderToggle(), b.interfaceDrag(), b.interfaceToggle()
            },
            overlayChange: function() {
                a("#xprecise-image").bind("change", function() {
                    a("#xprecise-overlay img").attr("src", a(this).val()), b.saveSettings()
                })
            },
            overlayToggle: function() {
                function c() {
                    "On" === d.text() ? (d.text("Off"), d.addClass("xprecise-off")) : (d.text("On"), d.removeClass("xprecise-off")), e.toggle(), b.saveSettings()
                }
                var d = a("#xprecise a.xprecise-toggle"),
                    e = a("#xprecise-overlay"),
                    f = !1;
                d.bind("click", function() {
                    ...
                    18 == a.which && (f = !0), 81 == a.which && f && c()
                }), "Off" === d.text() && (e.hide(), d.addClass("xprecise-off"))
            },
            overlayDrag: function() {
                a("#xprecise-overlay").draggable({
                    drag: function(b, c) {
                        a("#xprecise-top").val(c.position.top), a("#xprecise-left").val(c.position.left)
                    },
                    stop: function() {
                        b.saveSettings()
                    }
            ...
            overlayPosition: function() {
                var c = a("#xprecise-overlay"),
                    d = a("#xprecise-top"),
                    e = a("#xprecise-left");
                d.bind("change", function() {
                    c.css("top", a(this).val() + "px"), b.saveSettings()
                }), e.bind("change", function() {
                    c.css("left", a(this).val() + "px"), b.saveSettings()
                }), c.css("top", d.val() + "px"), c.css("left", e.val() + "px")
            },
            overlayFineTuning: function() {
                function c(a) {
                    var c = 1 * f.val() - 1;
                    "down" === a && (c = 1 * f.val() + 1), f.val(c), e.css("top", c + "px"), b.saveSettings()
                }

                function d(a) {
                    var c = 1 * g.val() - 1;
                    "right" === a && (c = 1 * g.val() + 1), g.val(c), e.css("left", c + "px"), b.saveSettings()
                }
                var e = a("#xprecise-overlay"),
                    f = a("#xprecise-top"),
                    g = a("#xprecise-left");
                e.hover(function() {
                    a(document).unbind("keypress.xprecise"), a(document).bind("keydown.xprecise", function(a) {
                        switch (a.keyCode) {
                            case 87:
                                c("up");
                                break;
                    ...
                    a(document).unbind("keydown.xprecise")
                })
            },
            overlayOpacity: function() {
                var c = a("#xprecise-overlay"),
                    d = a("#xprecise-opacity-value"),
                    e = 1 * d.text();
                c.css("opacity", e / 100), a("#xprecise-opacity").slider({
                    value: e,
                    slide: function(a, b) {
                        d.text(b.value), c.css("opacity", b.value / 100)
                    },
                    stop: function() {
                        b.saveSettings()
                    }
            ...
            pageOpacity: function() {
                var c = a("#xprecise-wrapper"),
                    d = a("#xprecise-page-opacity-value"),
                    e = 1 * d.text();
                c.css("opacity", e / 100), a("#xprecise-page-opacity").slider({
                    value: e,
                    slide: function(a, b) {
                        d.text(b.value), c.css("opacity", b.value / 100)
                    },
            ...
            overUnderToggle: function() {
                var c = a("#xprecise-overlay");
                a("#xprecise-over").bind("click", function() {
                    c.css("z-index", 1e4), b.saveSettings()
                }), a("#xprecise-under").bind("click", function() {
                    c.css("z-index", 1e3), b.saveSettings()
                }), a("#xprecise-over").is(":checked") ? c.css("z-index", 1e4) : c.css("z-index", 1e3)
            },
            getInterfacePosition: function() {
                var b = a("#xprecise").offset(),
                    c = b.top - a(window).scrollTop(),
                    d = b.left - a(window).scrollLeft(),
                    e = a(window).height(),
                    f = a(window).width(),
                    g = e - 35,
                    h = f - 200;
                return b.top = c, b.left = d, c > g && (b.top = g, a("#xprecise").css("top", b.top)), 0 > c && (b.top = 0, a("#xprecise").css("top", b.top)), d > h && (b.left = h, a("#xprecise").css("left", b.left)), 0 > d && (b.left = 0, a("#xprecise").css("left", b.left)), b
            },
            interfaceDrag: function() {
                a("#xprecise").draggable({
                    handle: "h2",
                    stop: function() {
                        b.saveSettings()
                    }
            ...
            interfaceToggle: function() {
                function c() {
                    var c = a("#xprecise a.xprecise-close");
                    d.toggle(), "–" === c.text() ? (c.text("+"), c.addClass("xprecise-closed")) : (c.text("–"), c.removeClass("xprecise-closed")), b.saveSettings()
                }
                var d = a("#xprecise form"),
                    e = a("#xprecise a.xprecise-close");
                a("#xprecise a.xprecise-close").bind("click", function() {
                    return c(), !1
                }), a("#xprecise h2").bind("dblclick", function() {
                    c()
                }), "+" === e.text() && (d.hide(), e.addClass("xprecise-closed"))
            },
            getImageFromURL: function() {
                var a = "",
                    b = location.pathname.split("/");
                return b.reverse(), a = "" !== b[0] ? "designs/" + b[0].replace(/(.html|.php)/, ".jpg") : "designs/index.jpg"
            },
            saveSettings: function() {
                var c, d, e, f = "|";
                c = "–" === a("#xprecise a.xprecise-close").text() ? "–" : "+", d = "On" === a("#xprecise a.xprecise-toggle").text() ? "On" : "Off";
                var g = this.getInterfacePosition();
                e = a("#xprecise-over").is(":checked") ? "over" : "under";
                var h = c + f + g.top + f + g.left + f + d + f + a("#xprecise-image").val() + f + a("#xprecise-top").val() + f + a("#xprecise-left").val() + f + a("#xprecise-opacity-value").text() + f + a("#xprecise-page-opacity-value").text() + f + e,
                    i = b.getCookieInfo();
                a.cookie(i.cookie_name, h, {
                    path: i.cookie_path,
                    expires: 365
                })
            },
            getCookieInfo: function() {
                var a = [],
                    b = location.pathname.split("/"),
                    c = b.pop();
                return a.cookie_path = b.join("/") + "/", a.cookie_name = "xprecise_" + c, a
            },
            loadSettings: function() {
                var c = [],
                    d = b.getCookieInfo();
                if (a.cookie(d.cookie_name)) {
                    var e = a.cookie(d.cookie_name).split("|");
                    c.interface = e[0], c.interface_top = e[1], c.interface_left = e[2], c.overlay = e[3], c.image = e[4], c.overlay_top = e[5], c.overlay_left = e[6], c.overlay_opacity = e[7], c.page_opacity = e[8], c.over_under = e[9]
                } else c.interface = "+", c.interface_top = 20, c.interface_left = 20, c.overlay = "Off", c.image = b.getImageFromURL(), c.overlay_top = 0, c.overlay_left = 0, c.overlay_opacity = 50, c.page_opacity = 100, c.over_under = "over";
                return c
            },
            checkExtension: function(a) {
                var b = new XMLHttpRequest;
                if (b.open("HEAD", a, !1), b.send(), this.onerror = function() {}, 404 == b.status && a.match(/.jpg/)) {
                    var c = a.replace(/.jpg/, ".png"),
                        d = new XMLHttpRequest;
                    d.open("HEAD", c, !1), d.send(), 404 != d.status && (a = c)
                }
                return a
            },
            ...
            interfaceAppend: function() {
                var c, d, e = this.loadSettings();
                "over" === e.over_under ? (c = ' checked="checked" ', d = "") : (d = ' checked="checked" ', c = ""), e.image = b.checkExtension(e.image);
                var f = a("body");
                f.children().not("script").wrapAll('<div id="xprecise-wrapper"></div>'), f.append('<div id="xprecise-overlay"><img src="' + e.image + '" alt="X-Precise Overlay" /></div>'), f.append('<div id="xprecise"> <h2><img src="http://xfiveco.github.io/x-precise/img/x.png" width="14" height="14" alt="X" /> - Precise <span><a href="#" class="xprecise-toggle">' + e.overlay + '</a> <a href="#" class="xprecise-close">' + e.interface + '</a></span></h2> <form action="#"> <div> <h3><label for="xprecise-image" class="design">Design</label> <span> <input type="radio" name="xprecise-switch" id="xprecise-over" ' + c + ' />    <label for="xprecise-over">over</label>    <input type="radio" name="xprecise-switch" id="xprecise-under" ' + d + ' />    <label for="xprecise-under">under</label></span></h3> <input type="text" value="' + e.image + '" id="xprecise-image" /> </div> <div> <h3>Position</h3> <label for="xprecise-top">top</label> <input type="text" value="' + e.overlay_top + '" id="xprecise-top" size="4" /> <label for="xprecise-left">left</label> <input type="text" value="' + e.overlay_left + '" id="xprecise-left" size="4" /> </div> <div>    <h3>Design opacity <span><span id="xprecise-opacity-value">' + e.overlay_opacity + '</span>%</span></h3> <div class="xprecise-slider"> <div id="xprecise-opacity"></div> </div> </div> <div> <h3>Page opacity <span> <span id="xprecise-page-opacity-value">' + e.page_opacity + '</span>%</span>    </h3> <div class="xprecise-slider"> <div id="xprecise-page-opacity"></div> </div> </div> </form> </div>'), a("#xprecise-overlay").css("position", "absolute"), a("#xprecise").css("top", e.interface_top + "px"), a("#xprecise").css("left", e.interface_left + "px"), b.isCanvasSupported() || a("#xprecise").addClass("oldies")
            }
        };
        a(function() {
            b.init()
